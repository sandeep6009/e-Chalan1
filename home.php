...
<body>
	<header class="header" id="header">
		...
		<div class="container">
			...
			<h2 style="color: white;"><b>JHARKHAND  POLICE</b></h2>
			<h1 class="animated fadeInDown delay-07s">WELCOME TO JHARKHAND TRAFFIC CONTROL</h1>
 ...
 <br></p>
	...
	<section class="main-section client-part" id="client">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12">
					<h4 style="font-style: italic; color: white;"> HI I M KUMAR VAIBHAW . MAKER OF THIS TRAFFIC POLICE MANAGEMENT WEBSITE. </h4>
				</div>
			</div>
			<ul class="client wow fadeIn delay-05s">
				<li><a href="#">
            	<img src="img/vaibhaw.jpeg" height="120" width="120" alt="">
                <h3>Kumar Vaibhaw</h3>
            </a></li>
			</ul>
		</div>
			...
			<div class="team-leader-block clearfix">
				<div class="team-leader-box">
					<div class="team-leader wow fadeInDown delay-03s">
						...
						<img src="img/acp1.jpeg" alt="">
					</div>
					<h3 class="wow fadeInDown delay-03s">Permila Rathore</h3>
					<span class="wow fadeInDown delay-03s">Superientendent of Police</span>
				</div>
				<div class="team-leader-box">
					<div class="team-leader  wow fadeInDown delay-06s">
						<div class="team-leader-shadow"><a href="#"></a></div>
						<img src="img/vaibhaw.jpeg" width="300" height="300" alt="">
					</div>
					<h3 class="wow fadeInDown delay-06s">KUMAR VAIBHAW</h3>
					<span class="wow fadeInDown delay-06s">Director General of Police</span>
				</div>
				<div class="team-leader-box">
					<div class="team-leader wow fadeInDown delay-09s">
						<div class="team-leader-shadow"><a href="#"></a></div>
						<img src="img/API.jpeg" width="300" height="300" alt="">
					</div>
