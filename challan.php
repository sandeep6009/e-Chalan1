            ...
            <div class="row mt-5">
                ...
                <form method="" id="signup-form" class="signup-form">
                    ...
                    <div class="form-group mt-5">
                      <label  class="mr-5"><span><h3 class="text-white">Driving License</h3></span>
                      </label>
                      <input type="checkbox" class="ctype" name="vname" value="5000" cname='Challan name' />
                    </div>
                    <div class="form-group mt-4">
                      <label  class="mr-5"><span><h3 class="text-white">Without Helmet</h3></span>
                      </label>
                      <input type="checkbox" class="ctype" name="vname" value="5000" cname='Challan name' />
                    </div>
                    <div class="form-group mt-4">
                      <label  class="mr-5"><span><h3 class="text-white">PUC(Pollution)</h3></span>
                      </label>
                      <input type="checkbox" class="ctype" name="vname" value="1000" cname='Challan name' />
                    </div>
                    <div class="form-group mt-4">
                      <label  class="mr-5"><span><h3 class="text-white">Without Insurance</h3></span>
                      </label>
                      <input type="checkbox" class="ctype" name="vname" value="4000" cname='Challan name' />
                    </div>
                    <div class="form-group mt-4">
                      <label  class="mr-5"><span><h3 class="text-white">Safety Belt  </h3></span>
                      </label>
                      <input type="checkbox" class="ctype" name="vname" value="1000" cname='Challan name' />
                    </div>
